    ...
    _createClass(Calculator, [{
        ...
        value: function render() {
            return React.createElement(
                "div",
                { className: css(styles.calculator__box) },
                React.createElement(
                    "h2",
                    { className: css(styles.text__topic) },
                    "\u041A\u0430\u043B\u044C\u043A\u0443\u043B\u044F\u0442\u043E\u0440 \u0434\u043E\u0445\u043E\u0434\u0430 Affilate Coin"
                ),
                React.createElement(MainPart, null),
                React.createElement(Result, null),
                React.createElement("div", { className: css(styles.calculator__result__background) })
            );
        }
    }]);
...
var MainPart = function (_React$Component2) {
    ...
    _createClass(MainPart, [{
        ...
        value: function render() {
            return React.createElement(
                "div",
                { className: css(styles.calculator__sum) },
                React.createElement(
                    "h6",
                    { className: css(styles.text__form) },
...
var Result = function (_React$Component3) {
    ...
    _createClass(Result, [{
        ...
        value: function render() {
            return React.createElement(
                "div",
                { className: css(styles.calculator__result) },
                React.createElement(
                    "p",
                    { id: "result", className: css(styles.text__result) },
                    "0.00$"
                )
            );
        }
